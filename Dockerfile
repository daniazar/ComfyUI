...
RUN pip install --no-cache-dir sqlalchemy aiohttp tqdm requests pillow scipy numpy huggingface_hub GitPython gguf mediapipe==0.10.14 accelerate "transformers<5.0.0"
